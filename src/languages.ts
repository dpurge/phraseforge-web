...
export const languages: LanguageConfig[] = [
  ...
  {code: 'bul', label: 'Bułgarski', levels: allLevels('Bułgarski')},
  {code: 'ces', label: 'Czeski', levels: allLevels('Czeski')},
  {code: 'cmn', label: 'Chiński', levels: allLevels('Chiński')},
  {code: 'dan', label: 'Duński', levels: allLevels('Duński')},
  {code: 'deu', label: 'Niemiecki', levels: allLevels('Niemiecki')},
  {code: 'ell', label: 'Nowogrecki', levels: allLevels('Nowogrecki')},
  {code: 'epo', label: 'Esperanto', levels: allLevels('Esperanto')},
  {code: 'fas', label: 'Perski', levels: allLevels('Perski')},
  {code: 'fin', label: 'Fiński', levels: allLevels('Fiński')},
  {code: 'fra', label: 'Francuski', levels: allLevels('Francuski')},
  {code: 'grc', label: 'Starogrecki', levels: allLevels('Starogrecki')},
  {code: 'heb', label: 'Hebrajski', levels: allLevels('Hebrajski')},
  {code: 'hin', label: 'Hindi', levels: allLevels('Hindi')},
  {code: 'hun', label: 'Węgierski', levels: allLevels('Węgierski')},
  ...
  {code: 'ron', label: 'Rumuński', levels: allLevels('Rumuński')},
  {code: 'rus', label: 'Rosyjski', levels: allLevels('Rosyjski')},
  {code: 'spa', label: 'Hiszpański', levels: allLevels('Hiszpański')},
  {code: 'srp', label: 'Serbski', levels: allLevels('Serbski')},
  {code: 'swa', label: 'Swahili', levels: allLevels('Swahili')},
  {code: 'swe', label: 'Szwedzki', levels: allLevels('Szwedzki')},
  {code: 'tat', label: 'Tatarski', levels: allLevels('Tatarski')},
  {code: 'tgk', label: 'Tadżycki', levels: allLevels('Tadżycki')},
  {code: 'tur', label: 'Turecki', levels: allLevels('Turecki')},
  {code: 'uig', label: 'Ujgurski', levels: allLevels('Ujgurski')},
  {code: 'ukr', label: 'Ukraiński', levels: allLevels('Ukraiński')},
  {code: 'uzb', label: 'Uzbecki', levels: allLevels('Uzbecki')},
  {code: 'vie', label: 'Wietnamski', levels: allLevels('Wietnamski')},
  {code: 'yid', label: 'Jidysz', levels: allLevels('Jidysz')},
];
